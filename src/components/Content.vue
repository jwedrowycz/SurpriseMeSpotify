<template>
	<div class="container h-100">
		<div class="row">
			<div class="col-lg-4">
				<div class="info-badge p-3 m-2 m-lg-5">
					<span>
						It' simple. Just fill the data you see. Search for artist name, track name or genre and look what Spotify will recommend you.
					</span>
				</div>
			</div>
