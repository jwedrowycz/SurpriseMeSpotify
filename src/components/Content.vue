	...
	<div>
		<div class="container">
			<div class="row">
				...
				<div class="mt-5 col-12 col-lg-6 col-xl-4">
					<div class="row mb-4 text-center">
						<h1 class="primary-color">
							<b>Surprise Me Spotify!</b>
						</h1>
					</div>
					<div class="col-lg-12">
						<div class="row mb-4">
							<div class="form-group">
								<form v-on:submit.prevent="getSearchResult">
									<div class="search-input">
										<input class="custom-input" type="search" placeholder="Start typing artist name" v-model="searchStringArtist" @keyup="getSearchArtistResult" />
						...
						<div class="row">
							<form v-on:submit.prevent="getSearchTrackResult">
								<div>
									<input class="custom-input" type="text" placeholder="Start typing track title" v-model="searchStringTrack" @keyup="getSearchTrackResult" />
				...
				<div class="col-lg-4 py-3 mt-5 footer m-0 mx-auto" style="background: #2d3338;">
					<div class="container" >
						<div class="text-center text-white">
							Thanks <span class="primary-color">Spotify</span> for providing this wonderful API.
					</div>
			</div>
		</div>	
			</div>
